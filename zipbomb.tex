...
we will assume that the compression ratio of the kernel
is exactly \num{1032},
and ignore filenames
...
containing $2^{16}-2$ files and a kernel that decompresses
to $2^{32}-\num{2178825}$ bytes.
...
\section{Efficient CRC-32 computation}
\label{sec:crc32}
